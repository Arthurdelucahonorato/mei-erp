...
export default function FormPedido({ formPedidoIsOpen, titleModal, toggleFormPedido, pedidoEdicao, clientes, produtos }: FormPedidosType) {
    ...
    useEffect(() => {
        if (pedidoEdicao) {
            ...
            setValue("codigoCliente", pedidoEdicao.cliente);
