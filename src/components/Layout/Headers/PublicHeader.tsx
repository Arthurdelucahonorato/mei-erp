...
export function PublicHeader() {
    ...
    return (
        <div className='flex flex-col align-middle justify-content-center w-full'>
            <nav className="flex flex-col md:flex-row justify-between flex-wrap bg-white p-6 w-full">
